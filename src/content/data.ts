...
export const CHECKLIST_TABLES: ChecklistTable[] = [
  {
    ...
    rows: [
      ...
      { no: 5, item: "[Doc Review] CI/PL - Correct Purpose of Shipment", complete: "YES", remarks: "CLEAR" },
      { no: 6, item: "[Doc Review] CI/PL - Correct Contents / Item Desc (No DG / Hazard / New Items)", complete: "YES", remarks: "CLEAR" },
      { no: 7, item: "[Doc Review] CI/PL - Correct Total Items", complete: "YES", remarks: "CLEAR" },
      { no: 8, item: "[Doc Review] CI/PL - Correct Total Value & Currency", complete: "YES", remarks: "CLEAR" },
      { no: 9, item: "[Doc Review] SKP - 1 Yr Abroad & Matched Contents with CI/PL", complete: "YES", remarks: "MATCHED" },
      { no: 10, item: "[Decision Check] Does This Shipment Require a Statement Letter?", complete: "NO", remarks: "EVERYTHING MATCHED" },
      { no: 11, item: "[Doc Review] Supporting Document 1 - Proof of Acceptance / Employment", complete: "YES", remarks: "LOA" },
      { no: 12, item: "[Doc Review] Supporting Document 2 - Proof of Completion / Contract End", complete: "YES", remarks: "IJAZAH" },
      { no: 13, item: "[Doc Review] Flight Ticket - Max 3 Months before/after Arrival in Indonesia", complete: "YES", remarks: "01 - 02 JAN 2026" },
      { no: 14, item: "[Decision Check] Does This Shipment Require a SP3BP?", complete: "NO", remarks: "H-6" },
      { no: 15, item: "[Conditional Document] ECD, Arrival Stamp, and Boarding Pass?", complete: "NO", remarks: "Cust Belum Sampai" },
      { no: 16, item: "[Table Review] Pickup Readiness", complete: "YES", remarks: "H-6 Flight" },
      { no: 17, item: "[Parcel Review] Box Packaging Eligible", complete: "YES", remarks: "CLEAR" },
    ],
  },

  {
    ...
    rows: [
      ...
      { no: 6, item: "[Doc Review] CI/PL - Correct Contents / Item Desc (No DG / Hazard / New Items)", complete: "YES", remarks: "CLEAR" },
      { no: 7, item: "[Doc Review] CI/PL - Correct Total Items", complete: "YES", remarks: "CLEAR" },
      { no: 8, item: "[Doc Review] CI/PL - Correct Total Value & Currency (<500 USD)", complete: "YES", remarks: "CLEAR" },
      { no: 9, item: "[Doc Review] Flight Ticket - Max 30 Days before and 15 Days after Arrival in Indonesia", complete: "YES", remarks: "01 - 02 JAN 2026" },
      { no: 10, item: "[Decision Check] Does This Shipment Require a SP3BP?", complete: "NO", remarks: "H-6" },
      { no: 11, item: "[Conditional Document] ECD, Arrival Stamp, and Boarding Pass?", complete: "NO", remarks: "Cust Belum Sampai" },
      { no: 12, item: "[Table Review] Pickup Readiness", complete: "YES", remarks: "H-6 Flight" },
      { no: 13, item: "[Parcel Review] Box Packaging Eligible", complete: "YES", remarks: "CLEAR" },
    ],
  },

  {
    ...
    rows: [
      ...
      { no: 8, item: "[Decision Check] Does This Shipment Require a PIBK or CN?", complete: "YES", remarks: "<1500 USD (CN), >1500 USD (PIBK)" },
      { no: 9, item: "[Doc Review] Goods Invoice and Product Purchase Link", complete: "YES", remarks: "MATCHED" },
      { no: 10, item: "[Table Review] Pickup Readiness", complete: "YES", remarks: "H-6 Flight" },
      { no: 11, item: "[Parcel Review] Box Packaging Eligible", complete: "YES", remarks: "CLEAR" },
    ],
  },
];
